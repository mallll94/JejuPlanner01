    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function goodsUpdate() {
                ...
                placeFk = $("#updateGoodsplaceFk").val()
                $.ajax({
                    url: "${path}/ajax",
                    type: "post",
                    data: {
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <input type="text" class="spiner-text" id="goodsplaceFk" value="">
                            </div>
                        </div>

                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal" id="goodsInsert"
                                onclick="goodsInsert()">등록</button>
